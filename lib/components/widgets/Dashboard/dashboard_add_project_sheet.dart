...
import 'package:myey/components/widgets/Buttons/rect_primary_button.dart';
import 'package:myey/components/widgets/Chat/badged_title.dart';
import 'package:myey/components/widgets/Forms/form_input_unlabelled.dart';
        ...
        Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Container(
                  ...
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: HexColor.fromHex("181A1F")),
                  child: Row(children: [
                    Expanded(
                      flex: 1,
                      child: RectPrimaryButtonWithIcon(
                          buttonText: "List", icon: Icons.checklist, itemIndex: 0, notifier: _settingsButtonTrigger),
                    ),
                    Expanded(
                      flex: 1,
                      child: RectPrimaryButtonWithIcon(
                          buttonText: "Board", icon: Icons.checklist, itemIndex: 1, notifier: _settingsButtonTrigger),
                    )
                  ])),
              AppSpaces.verticalSpace20,
              Row(children: [
              ...
              AppSpaces.verticalSpace10,
              Transform.scale(
                  scale: 0.8, alignment: Alignment.centerLeft, child: buildStackedImages(numberOfMembers: "2")),
              AppSpaces.verticalSpace20,
